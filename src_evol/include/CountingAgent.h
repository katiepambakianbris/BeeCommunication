...
class CountingAgent {
	public:
		...
		void ResetSensors(void) {landmarkSensor = 0; otherSensor = 0;};
		...
		double pos, gain, landmarkSensor, otherSensor;
		TVector<double>landmarksensorweights, othersensorweights;
		CTRNN NervousSystem;
};
